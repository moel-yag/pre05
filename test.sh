...
echo ""
echo "=== Rectangular Board Tests ==="

run_test "Rect: 3x2 blinker H" "xdx" 3 2 1 $'   \nOOO'
run_test "Rect: 2x3 blinker V" "sxax" 2 3 1 $' O\n O\n O'
...
echo -e "${RED}Some tests failed.${NC}" && exit 1#!/bin/bash
