...
bigint& bigint::operator=(const bigint& o) { v = o.v; return *this; }
...
bigint bigint::operator<<(unsigned int s) const {
    bigint t(*this); if (t.v != "0") t.v.append(s, '0'); return t;
}
bigint& bigint::operator<<=(unsigned int s) { return *this = *this << s; }
...
bigint bigint::operator<<(const bigint& o) const { return *this << std::stoul(o.v); }
bigint& bigint::operator<<=(const bigint& o) { return *this = *this << o; }
bigint bigint::operator>>(const bigint& o) const { return *this >> std::stoul(o.v); }
bigint& bigint::operator>>=(const bigint& o) { return *this = *this >> o; }
...
std::ostream& operator<<(std::ostream& os, const bigint& o) { return os << o.getValue(); }